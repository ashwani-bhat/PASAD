...
oneSensor_val = validation[:,14:15]
...
# plt.plot([i/100 for i in range(500)],train[:,14],'b',label='Training data')
# plt.plot([i/100 for i in range(251,4000)],validation[:,14],'g',label ='Validation data')
# plt.plot([i/100 for i in range(3751,4800)],test[:,14],'r',label='Testing data')
